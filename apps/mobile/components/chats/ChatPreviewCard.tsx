 ...
 * Mixed inbox (All tab): mode dot, left accent, pill badge, mode-colored unread.
 */
...
type ChatPreviewCardProps = {
  ...
  /** When true (e.g. All tab), show mode badge + accent so mixed inbox is scannable. */
...
export function ChatPreviewCard({
  ...
  const avatarRingStyle = modeDisplay
          ...
          <View style={styles.titleBlock}>
            ...
            {(modeDisplay || isPendingRomanceInvite || conversation.type === "event") && (
              <View style={styles.badgeRow}>
                {modeDisplay && (
                  <View style={[styles.modeBadge, { backgroundColor: modeDisplay.secondary }]}>
                    <View style={[styles.modeBadgeDot, { backgroundColor: modeDisplay.primary }]} />
                    <Text style={[styles.modeBadgeText, { color: modeDisplay.primary }]}>
                      {modeDisplay.label}
                    </Text>
                  </View>
                )}
