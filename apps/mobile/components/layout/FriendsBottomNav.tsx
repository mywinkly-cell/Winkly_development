...
// Same structure as Romance; Friends mode colors
// ────────────────────────────────────────────────
...
export function FriendsBottomNav() {
  ...
  const isActive = (tab: FriendsTab) => activeTab === tab;
  const activeColor = Colors.friends.primary;
  ...
  return (
    ...
    >
      ...
      <ModeSwitchCenterButton mode="friends" />
